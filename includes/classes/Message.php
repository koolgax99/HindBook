...
class Message
{
	...
	public function getMessages($otherUser)
	{
		...
		while ($row = mysqli_fetch_array($get_messages_query)) {
			...
			$div_top = ($user_to == $userLoggedIn) ? "<div class='your-msg' align='left' style='margin-bottom: 15px;' ><span style='border-radius: 25px;background-color: #ccc;color: white;padding: 10px;' >" : "<div class='my-msg' align='right' style='margin-bottom: 15px;'><span style='border-radius: 25px;background-color: skyblue;color: white;margin-bottom: 15px;padding: 10px;'>";
			$button = "<button class='btn btn-danger' onclick='deleteMessage($id, this)'>X</button>";
			$data = $data . $div_top . " " . $body . "</span></div>";
		}
		return $data;
	}
